...
/** SensorEnginePlugin */
public class SensorEnginePlugin: FlutterPlugin, MethodCallHandler {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      val channel = MethodChannel(registrar.messenger(), "sensor_engine")
      channel.setMethodCallHandler(SensorEnginePlugin())
    }
  }
